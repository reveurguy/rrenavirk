...
const navigationMenuTriggerStyle = cva(
  'hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 group inline-flex  h-10 w-max items-center justify-center rounded-md px-4 py-2 text-lg font-bold tracking-tight hover:bg-zinc-200 focus:outline-none disabled:pointer-events-none disabled:opacity-50'
);
